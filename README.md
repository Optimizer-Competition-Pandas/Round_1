...
برای این بخش از روش خاصی استفاده نکردیم و همان جواب مرحله دوم را آپلود کردیم. چون مرحله دوم همین قید‌ها را داشت پس جوابش برای این مرحله شدنی می‌شود

## ⛓️ محدودیت‌ها <a name = "limitations"></a>
روش ما محدودیت خاصی ندارد
## 🚀 ایده‌های گسترش <a name = "future_scope"></a>
این مرحله ساده تر از آن است که نیازی به گسترش باشد. در واقع جواب شدنی می‌خواست که پیدا کردیم و کار بیشتری نمی‌توان کرد
