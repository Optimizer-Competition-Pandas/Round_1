...
برای این بخش کار خاصی نکردیم و جواب مرحله دوم را آپلود کردیم. چون در مرحله دوم هم قید‌ها همین بود جواب آن یک جواب شدنی می‌شود
## ⛓️ محدودیت‌ها <a name = "limitations"></a>
روش ما محدودیت خاصی ندارد
## 🚀 ایده‌های گسترش <a name = "future_scope"></a>
یک جواب شدنی می‌خواست که ارائه کردیم. این مرحله جایی برای گسترش ندارد
